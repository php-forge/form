...
final class InputAttibutesTest extends TestCase
{
    ...
    public function testMaxLength(): void
    {
        $this->assertSame(
            ...
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->maxlength(10)->render(),
        );
    }
    ...
    public function testMinLength(): void
    {
        $this->assertSame(
            ...
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->minlength(4)->render(),
        );
    }
    ...
    public function testPattern(): void
    {
        ...
        HTML;
        $html = Tel::create(construct: [new PropertyTypeForm(), 'string'])
            ->pattern('[A-Za-z]')
    ...
    public function testPlaceholder(): void
    {
        $this->assertSame(
            ...
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->placeholder('test.placeholder')->render(),
        );
    }
    ...
    public function testSize(): void
    {
        $this->assertSame(
            ...
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->size(10)->render(),
        );
    }
    ...
    public function testValue(): void
    {
        ...
        $this->assertSame(
            ...
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->value('test.string')->render(),
        );

        // Value `null`.
        $this->assertSame(
            '<input id="propertytypeform-string" name="PropertyTypeForm[string]" type="tel">',
            Tel::create(construct: [new PropertyTypeForm(), 'string'])->value(null)->render(),
        );
    }
    ...
    public function testValueWithFormModel(): void
    {
        ...
        $this->assertSame(
            '<input id="propertytypeform-string" name="PropertyTypeForm[string]" type="tel" value="test.string">',
            Tel::create(construct: [$formModel, 'string'])->render(),
        );
