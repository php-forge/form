...
final class RadioTest extends TestCase
{
    ...
    public function testAnyLabel(): void
    {
        ...
        $assert->equalsWithoutLE(
            <<<HTML
            <div>
            <input id="propertytypeform-string" name="PropertyTypeForm[string]" type="radio">
            </div>
            HTML,
            Field::create()
                ->widget(Radio::create(construct: [new PropertyTypeForm(), 'string'])->label(null))
                ->label(null)
                ->render(),
        );
    }
    ...
    public function testAriaDescribedBy(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            <input id="hinttypeform-string" name="HintTypeForm[string]" type="radio" aria-describedby="hinttypeform-string-help">
            ...
            HTML,
            Field::create()
                ->widget(Radio::create(construct: [new HintTypeForm(), 'string'])->ariaDescribedBy(true))
                ->render()
        );
        ...
        $assert->equalsWithoutLE(
            ...
            <div>
            <label for="hinttypeform-string">String</label>
            <input id="hinttypeform-string" name="HintTypeForm[string]" type="radio" aria-describedby="test.ariaDescribedBy">
            ...
            Field::create()
                ->widget(
                    Radio::create(construct: [new HintTypeForm(), 'string'])->ariaDescribedBy('test.ariaDescribedBy')
                )
                ->render()
        );
    }
    ...
    public function testError(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            <div>
            <label for="hinttypeform-string">String</label>
            <input id="hinttypeform-string" name="HintTypeForm[string]" type="radio">
            <div>
            Hint for string
            </div>
            <div>
            ...
            HTML,
            Field::create()
                ->widget(Radio::create(construct: [new HintTypeForm(), 'string']))
    ...
    public function testErrorMessageCallback(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            HTML,
            Field::create()
                ->widget(Radio::create(construct: [$formModel, 'string']))
    ...
    public function testRender(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            HTML,
            Field::create()
                ->widget(Radio::create(construct: [new PropertyTypeForm(), 'bool']))
                ->render()
        );
    }
