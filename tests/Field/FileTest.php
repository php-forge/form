...
final class FileTest extends TestCase
{
    ...
    public function testAriaDescribedBy(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            <input id="hinttypeform-string" name="HintTypeForm[string][]" type="file" aria-describedby="hinttypeform-string-help">
            ...
            HTML,
            Field::create()
                ->widget(File::create(construct: [new HintTypeForm(), 'string'])->ariaDescribedBy(true))
                ->render()
        );
        ...
        $assert->equalsWithoutLE(
            ...
            <div>
            <label for="hinttypeform-string">String</label>
            <input id="hinttypeform-string" name="HintTypeForm[string][]" type="file" aria-describedby="test.ariaDescribedBy">
            ...
            Field::create()
                ->widget(
                    File::create(construct: [new HintTypeForm(), 'string'])->ariaDescribedBy('test.ariaDescribedBy')
                )
                ->render()
        );
    }
    ...
    public function testError(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            <div>
            <label for="hinttypeform-string">String</label>
            <input id="hinttypeform-string" name="HintTypeForm[string][]" type="file">
            <div>
            Hint for string
            </div>
            <div>
            ...
            HTML,
            Field::create()
                ->widget(File::create(construct: [new HintTypeForm(), 'string']))
    ...
    public function testErrorMessageCallback(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            HTML,
            Field::create()
                ->widget(File::create(construct: [$formModel, 'string']))
    ...
    public function testRender(): void
    {
        ...
        $assert->equalsWithoutLE(
            ...
            HTML,
            Field::create()
                ->widget(File::create(construct: [new PropertyTypeForm(), 'string']))
                ->render()
        );
    }
